...
public class Field {
    ...
    // Barge
    public static final Pose2d blueBargeMiddle = new Pose2d(Inches.of(345.4375), Inches.of(242.875), Rotation2d.fromDegrees(180)); // This is the same pose as the middle cage
    ...
    public static final Pose2d redBargeMiddle = new Pose2d(Inches.of(345.4375), fieldWidth.minus(blueCageMid.getMeasureY()), Rotation2d.fromDegrees(0)); // This is the same pose as the middle cage
